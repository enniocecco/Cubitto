...
xhr.send();
  ...
  return (
    <View darkColor="black" style={styles.container}>
      <Image style={{width: 112, height: 230}} source={require('../assets/images/satan.png')} />
<View style={{height: 20}} />
      <Text style={styles.title}>Cubitto</Text>
...
<Button
      ...
      <EditScreenInfo path="/screens/TabTwoScreen.jsx" />
